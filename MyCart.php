            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="RemoveAll.php?c_id=<?= $data['c_id']?>" class="btn btn-primary">Yes</a>
					...
					<div class="btn btn-info text-white fixed-bottom" style="margin-right:20%;height:70px;width:20%;padding:25px;margin-left:30%">
						 <b> Total ₹ <?= $total+20?>/-</b><br><br>
						 <a href="product.php" class="btn btn-success text-white fixed-bottom" style="height:70px;width:115%;padding:25px;margin-left:-7.5%">
								<b>CONTINUE SHOPPING</b>
					</a>


					<br>
					<a href="#emptyCart"  class="btn btn-danger fixed-bottom " data-toggle="modal"  style="height:70px;width:115%;padding:25px;margin-left:-7.5%"> <b>EMPTY CART</b></a>
